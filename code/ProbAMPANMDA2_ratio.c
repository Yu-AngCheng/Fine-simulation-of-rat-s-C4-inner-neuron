...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 7;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA2_RATIO C:/Users/Yuang Cheng/Documents/Courses/high_frequency/数字媒体技术/new ppt/Homework/ProbAMPANMDA2_ratio.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 103 in file ProbAMPANMDA2_ratio.mod:\n        SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "ProbAMPANMDA2_ratio.mod";
static const char* nmodl_file_text = 
